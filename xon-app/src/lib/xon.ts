...
import type { ContentItem, Details, EpisodeItem, HomeRow, StreamQuality, StreamResponse } from './types';
...
function getHeaders(): Record<string, string> {
  ...
  return {
    ...
    // Avoid "forbidden" headers like Host/Connection that can cause fetch to throw in Next/undici.
